...
public class TaskDAOImplTest {
	...
	public void test_Get_All_Tasks() throws Exception{
		...
		Optional<ParentTask> task=	this.parentRepositoryMock.findById((String) this.entityManager.persistAndGetId(new ParentTask("Parent Test H2 Task")));
		 this.entityManager.persistAndGetId(new Task(project.get(),task.get(), "TASK1 for H2 Testing", new Date(), new Date(), 10, TaskStatus.COMPLETED));
		 this.entityManager.persistAndGetId(new Task(project.get(),task.get(), "TASK2 for H2 Testing", new Date(), new Date(), 9, TaskStatus.INPROGRESS));
		 this.entityManager.persistAndGetId(new Task(project.get(),task.get(), "TASK3 for H2 Testing", new Date(), new Date(), 0, TaskStatus.INPROGRESS));
	...
	public void test_Get_Task_By_Id() throws Exception {
		Optional<Project> project=	this.projectRepositoryMock.findById((String) this.entityManager.persistAndGetId(new Project("Test1 Project", new Date(), new Date(), 10)));
		Optional<ParentTask> task=	this.parentRepositoryMock.findById((String) this.entityManager.persistAndGetId(new ParentTask("Parent Test H2 Task")));
		String taskID = (String) 	 this.entityManager.persistAndGetId(new Task(project.get(),task.get(), "ID TASK1 for H2 Testing", new Date(), new Date(), 10, TaskStatus.INPROGRESS));
	...
	public void test_Add_Task() throws Exception{
		Optional<Project> project=	this.projectRepositoryMock.findById((String) this.entityManager.persistAndGetId(new Project("Test1 Project", new Date(), new Date(), 10)));
		Optional<ParentTask> task=	this.parentRepositoryMock.findById((String) this.entityManager.persistAndGetId(new ParentTask("Parent Test H2 Task")));
		String taskID = (String) 	 this.entityManager.persistAndGetId(new Task(project.get(),task.get(), "ADD TASK1 for H2 Testing", new Date(), new Date(), 10, TaskStatus.INPROGRESS));
		Optional<Task> actual = this.taskRepositoryMock.findById(taskID);
	...
	public void test_Update_Task() throws Exception{		
		Optional<Project> project=	this.projectRepositoryMock.findById((String) this.entityManager.persistAndGetId(new Project("Test1 Project", new Date(), new Date(), 10)));
		Optional<ParentTask> task=	this.parentRepositoryMock.findById((String) this.entityManager.persistAndGetId(new ParentTask("Parent Test H2 Task")));
		String taskID = (String) 	 this.entityManager.persistAndGetId(new Task(project.get(),task.get(), "TASK1 for H2 Testing", new Date(), new Date(), 10, TaskStatus.INPROGRESS));
		Optional<Task> actual = this.taskRepositoryMock.findById(taskID);
